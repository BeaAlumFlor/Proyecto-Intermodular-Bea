...
router.post("/rutapost2conformulario", (req, res) => {
  ...
  res.redirect("http://127.0.0.1:5500/Proyecto/src/Frontend/Formulario1-AP8.html");
...
router.post("/rutapost3conformulario", (req, res) => {
  ...
  //res.redirect("http://127.0.0.1:5500/Proyecto/src/Frontend/Formulario2-AP8.html");
